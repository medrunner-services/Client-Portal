...
<template>
    <div class="content-container">
		<h1 class="text-center text-3xl lg:text-4xl font-Mohave font-semibold uppercase">Medrunner Blacklist</h1>

		<form @submit.prevent="searchBlocklist()" class="lg:flex lg:w-full lg:justify-between mt-14">
