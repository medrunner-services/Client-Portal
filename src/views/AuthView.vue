...
onMounted(() => {
    ...
    if (route.path === '/auth/register') {
        axios.get(`http://ec2co-ecsel-7i88sw5ak5o0-1780126779.us-west-2.elb.amazonaws.com/auth/register?code=${urlParams.get('code')}&redirectUri=http://localhost:5173/auth/register`)
            .then((response) => {
