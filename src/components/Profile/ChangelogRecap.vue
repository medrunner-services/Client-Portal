...
<template>
	<div>
		<div class="flex min-h-11 items-center justify-between">
			...
			<p class="rounded-full bg-primary-100 px-2 py-1 text-xs font-semibold text-primary-600">
				v{{ appVersion }}
			</p>
		</div>
