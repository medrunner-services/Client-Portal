...
onMounted(() => {
    if (userStore.redeemedCodes.some(code => code.type === CodeType.CITIZEN_CON_2954)) {
...
<template>
    <div>
        <div class="flex min-h-11 items-center justify-between">
            ...
            <GlobalButton size="full" icon="logout" :loading="isLoggingOut" @click="disconnectUser()">
                {{ t("navbar_disconnect") }}
            </GlobalButton>
        </div>
        ...
        <GlobalCard class="mt-4 flex flex-col items-center justify-center">
            <div class="w-full">
                <div
                    v-if="userStore.user.rsiHandle" class="
                ...
                >
                    ...
                    <div class="lg:flex lg:items-end">
                        ...
                        >
                            {{ isEditingUsername ? t("form_confirm") : t("form_edit") }}
                        </GlobalButton>
                        <GlobalButton
                ...
                <p
                    v-if="errorUpdatingUsername" class="
            ...
            <div
                ...
                " :class="userStore.user.rsiHandle ? 'mt-4' : ''"
            >
                <div>
                    <p
                        class="
                ...
                <div class="w-full">
                    ...
                    >
                        <div
                            ...
                            :key="badge.name"
                            class="
                                flex items-center rounded-lg border border-gray-300 bg-gray-50 px-2.5 py-1.5 text-sm text-gray-900
                                dark:border-gray-600 dark:bg-gray-700 dark:text-white
                            "
                        >
