    ...
    <div class="relative">
        ...
        >
            <div v-if="props.level" class="flex items-center p-2">
                <img :src="`/icons/medals/${level}.png`" alt="Success Medal" class="mr-2 h-5 w-5" />
                <p>
                    {{ t("tracking_levelTier") }} {{ splitOnLastZero(props.level.toString())[0] }} {{ t("tracking_levelSection") }}
