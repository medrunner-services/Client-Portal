...
<template>
    <div>
        ...
        <div class="mt-8">
            <ol
                class="
                    mb-6 flex items-center text-center text-sm font-medium text-gray-500
                    sm:text-base
                    lg:mb-8
                    dark:text-gray-400
                "
        ...
        >
            <div>
                <GlobalButton
                    v-if="currentFormPart === 3" :loading="submittingDetails" class="
                        w-full
                        lg:w-fit
                    " size="full" @click="sendDetails()"
                >
                    {{
                ...
                <GlobalButton
                    v-else class="
                        w-full
                        lg:w-fit
                    " size="full" @click="currentFormPart++"
                >
                    {{ t("login_continue") }}
                </GlobalButton>
            </div>
            ...
            <div>
                ...
                <GlobalButton
                    v-else class="
                        w-full
                        lg:w-fit
                    " size="full" type="secondary" icon="arrowLeft" @click="currentFormPart--"
                >
                    {{
