...
<template>
    <form @submit.prevent="sendNewEmergency()">
        ...
        <div class="mt-10 lg:flex lg:w-full lg:justify-between">
            <div class="lg:w-[48%]">
                <LabelInput title-local="form_system" description-local="form_helpSystem" :required="true" />
                <div class="mt-2">
            ...
            <div class="mt-5 lg:mt-0 lg:w-[48%]">
                <LabelInput title-local="form_subSystem" description-local="form_helpSubSystem" :required="true" />
                <div class="mt-2">
                    <select
