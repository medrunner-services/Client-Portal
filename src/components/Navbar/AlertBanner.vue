...
<template>
    <div
        v-if="showBanner"
        id="banner"
        class="flex w-full flex-col items-start justify-between border border-b border-gray-200 bg-yellow-100 px-4 py-3 text-yellow-800 dark:border-0 md:flex-row md:items-center md:gap-8 lg:py-4"
    >
        <div class="sm:flex xl:items-center">
            <svg class="mb-3 mr-3 hidden h-5 w-5 shrink-0 sm:mb-0 lg:flex" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                <path
                    fill-rule="evenodd"
        ...
        <div class="flex shrink-0 items-center space-x-4 lg:pl-10">
            <GlobalButton
                type="outline"
                size="full"
