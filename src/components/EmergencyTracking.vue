    ...
    <div>
        ...
        <div class="mt-10" v-if="emergencyStatus === 'received' || emergencyStatus === 'ongoing'">
            <div class="lg:flex lg:justify-between">
                <div class="p-4 shadow-md bg-gray-50 lg:w-[30%]">
                    <p class="font-Mohave font-semibold text-2xl lg:text-xl"><span>🌌</span>System</p>
                    <p class="mt-2">Stanton</p>
                </div>
                <div class="p-4 shadow-md bg-gray-50 mt-5 lg:mt-0 lg:w-[30%]">
                    <p class="font-Mohave font-semibold text-2xl lg:text-xl"><span>🌍</span>Sub System</p>
                    <p class="mt-2">Crusader</p>
                </div>
                <div class="p-4 shadow-md bg-gray-50 mt-5 lg:mt-0 lg:w-[30%] h-fit">
                    <p class="font-Mohave font-semibold text-2xl lg:text-xl"><span>⚔️</span>Threat Level</p>
                    <p class="mt-2">High</p>
                </div>
            </div>
        ...
        <div v-else class="mt-10">
            ...
            <div class="flex w-full justify-between mt-5">
                <button class="p-3 cursor-pointer font-semibold border-2 border-primary-900 w-[45%]">Good</button>
                <button class="p-3 cursor-pointer font-semibold border-2 border-primary-900 w-[45%]">Bad</button>
            </div>
        </div>
    </div>
</template>
