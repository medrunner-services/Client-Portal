...
import { Class, MissionStatus } from "@medrunner/api-client";
    ...
    <div>
        ...
        <div
            v-if="showDetails" ref="detailsDiv" class="
                w-full flex-1 overflow-x-auto bg-gray-50
                dark:bg-gray-900
            "
        >
            <div
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <p
                            ...
                            "
                        >
                            {{ getThreatString(props.emergency.threatLevel) }}
                        </p>
                    </div>
                    <div
                    ...
                    >
                        ...
                        <p
                            ...
                            "
                        >
                            {{ getRatingString(props.emergency.rating) }}
                        </p>
                    </div>
                    <div
                ...
                <div class="mt-4 grid w-full gap-4">
                    ...
                    >
                        <p
                            ...
                            "
                        >
                            {{ t("history_responders") }}
                        </p>
                        <p
                            v-if="teamLeader" class="
                                text mb-2 text-base text-gray-500
                                dark:text-gray-400
                            "
                        >
                        ...
                        <p
                            ...
                            "
                        >
                            {{ getResponders(props.emergency.respondingTeam.staff) }}
                        </p>
                    </div>
                </div>
                <div class="mt-4">
                    <p
                        class="
                            cursor-pointer text-sm text-gray-500 underline
                            dark:text-gray-400
                        "
                    ...
                    <div
                        v-if="showMissionDebugInfo" class="
                            mt-2 h-fit rounded-lg border border-gray-200 px-4 py-2.5
                            dark:border-gray-700
                        "
                    >
                        <div
                ...
                <GlobalButton
                    size="full" type="outline-solid" class="
                        mt-4
                        lg:w-fit
