export const multiSelectInputDefaultClasses = {
    ...
    tag: "bg-primary-600 text-white text-sm font-medium py-0.5 pl-2 rounded-sm mr-1 mb-1 flex items-center whitespace-nowrap",
    ...
    tagRemoveIcon: "bg-cross-pattern text-white bg-center bg-no-repeat inline-block w-3 h-3 group-hover:opacity-80",
    ...
    optionsTop: "",
    group: "p-0 m-0",
    groupLabel: "flex text-sm box-border items-center justify-start text-left py-1 px-3 font-semibold text-primary-600 dark:text-primary-500 cursor-default leading-normal",
    groupLabelPointable: "cursor-pointer",
    groupLabelPointed: "text-gray-700 bg-gray-100 dark:bg-gray-600",
    groupLabelSelected: "text-white",
    groupLabelDisabled: "opacity/50 text-gray-300 cursor-not-allowed",
    groupLabelSelectedPointed: "opacity-70",
    groupLabelSelectedDisabled: "opacity-70 cursor-not-allowed",
    groupOptions: "pl-4 m-0",
