export const multiSelectInputDefaultClasses = {
    container:
        "relative mx-auto w-full bg-gray-50 dark:bg-gray-700 dark:text-white flex items-center justify-end box-border cursor-pointer dark:border-gray-600 border border-gray-300 rounded-lg text-base leading-snug outline-none",
    ...
    tag: "bg-primary-600 text-white text-sm font-medium py-0.5 pl-2 rounded mr-1 mb-1 flex items-center whitespace-nowrap",
