...
const downloadLocals = async () => {
	const response = await fetch('https://crowdin.com/api/v2/projects/564465/bundles/3/exports', {
		method: "POST",
		headers: {
	...
	const responseDownload = await fetch(`https://crowdin.com/api/v2/projects/564465/bundles/3/exports/${parsedResponse.data.identifier}/download`, {
		method: "GET",
		headers: {
			"Content-Type": "application/json",
			"Authorization": `Bearer ${process.env.CROWDIN_TOKEN}`,
